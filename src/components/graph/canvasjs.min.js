...
(function() {
	...
	function hb(h) {
		if (!ib) {
			var p = !1,
				D = !1;
			"undefined" === typeof ra.Chart.creditHref ? (h.creditHref = ja(""), h.creditText = ja("")) : (p = h.updateOption("creditText"), D = h.updateOption("creditHref"));
	...
	Na.Chart = function() {
		...
		$.prototype._initialize = function() {
			if (this.enabled) {
				...
				a += "user-select: none;";
				r || (a += "filter: alpha(opacity = 90);", a += "filter: progid:DXImageTransform.Microsoft.Shadow(Strength=3, Direction=135, Color='#000000');");
