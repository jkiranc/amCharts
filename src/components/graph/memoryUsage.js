...
export default class MemoryUsage extends Component {
    ...
    componentDidMount() {
        ...
        var chart = am4core.create("memoryUsageDiv", am4charts.XYChart);
    ...
    render() {
        return (
            <div id="memoryUsageDiv" style={{ width: '100%', height: "276px", backgroundColor: "white", marginTop: "2%", boxShadow: "0px 0px 5px 5px rgba(0, 0, 0, 0.1)" }}>
            </div>
        )
    }
}
