...
export default class TimeLinePie extends Component {
    ...
    componentDidMount() {
        ...
        var chart = am4core.create("rangechart", am4charts.XYChart);

        chart.data = [{ date: 1577879023000, open: 122, close: 104 },
    ...
    render() {
        return (
            <div id="rangechart" style={{ width: '100%', height: "270px", backgroundColor: "white", marginTop: "2%", boxShadow: "0px 0px 5px 5px rgba(0, 0, 0, 0.1)" }}>
            </div>
        )
    }
}
