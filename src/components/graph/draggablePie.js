...
export default class DraggablePie extends Component {
    ...
    componentDidMount() {
        var data = [{
            ...
            "country": "Standard SSD",
            "litres": 301.9
        }, {
            "country": "Ultra SSd",
            "litres": 201.1
        }, {
            "country": "Standard HDD",
            "litres": 165.8
        }];
    ...
    render() {
        return (
            <>
                ...
                <div id="chartdiv" style={{ width: '100%', height: "270px", marginTop: "1%", backgroundColor: "white", boxShadow: "0px 0px 5px 5px rgba(0, 0, 0, 0.1)" }}>
                </div>
            </>
        )
    }
