...
export default class DrillDownTreeMap extends Component {
    ...
    componentDidMount(){        
        ...
        var data = {
          ...
          // create chart
          var chart = am4core.create("drilldowntreemapdiv", am4charts.TreeMap);
    ...
    render() {
        return (
            <div id="drilldowntreemapdiv" style={{ width: '100%', height: "400px"}}>
            </div>
        )
    }
}
