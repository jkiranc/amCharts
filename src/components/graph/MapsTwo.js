...
export default class Maps extends Component {
    ...
    render() {
        return (
            <>
                <div id="mapsdiv" style={{ width: '100%', height: "270px", backgroundColor: "white", boxShadow: "0px 0px 5px 5px rgba(0, 0, 0, 0.1)" }}></div>
                <div id="hiddenchartdiv" style={{ width: '100%', height: "270px", backgroundColor: "white", boxShadow: "0px 0px 5px 5px rgba(0, 0, 0, 0.1)" }}></div>
            </>
        )
    }
}
