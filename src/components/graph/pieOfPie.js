...
export default class PieOfPie extends Component {

    componentDidMount(){        
    
        // cointainer to hold both charts
        var container = am4core.create("pieOfPiediv", am4core.Container);
...
chart.events.on("datavalidated", function() {
  setTimeout(function() {
    ...
    render() {
        return (
            <div id="pieOfPiediv" style={{ width: '100%', height: "500px"}}>
            </div>
        )
    }
}
